<x-admin-layout title="Añadir Carrera" headerText="Módulo de Carreras Académicas">
    <div class="mb-6">
        ...
        <h2 class="font-display text-headline-md font-bold text-on-surface">Añadir Nueva Carrera</h2>
        <p class="font-body-sm text-on-surface-variant">Registra una nueva carrera profesional para la comunidad de estudiantes.</p>
    </div>

    <!-- Form Card -->
    <div class="glass-panel rounded-lg p-6 max-w-lg">
        <form action="{{ route('admin.carreras.store') }}" method="POST" class="space-y-6">
            @csrf
