<x-admin-layout title="Crear Grupo Académico" headerText="Módulo de Grupos y Cátedras">
    <div class="mb-6">
        ...
        <h2 class="font-display text-headline-md font-bold text-on-surface">Crear Grupo Académico</h2>
        <p class="font-body-sm text-on-surface-variant">Registra la cátedra de una materia vinculada a un docente y su calificación promedio.</p>
    </div>
            ...
            <div>
                ...
                <div class="space-y-2">
                    ...
                    <select
                        ...
                        required
                    >
                        <option value="" disabled selected class="text-on-surface-variant">-- Selecciona un docente --</option>
                        @foreach($docentes as $docente)
                            <option value="{{ $docente->id }}" {{ old('docente_id') == $docente->id ? 'selected' : '' }} class="py-1.5 px-2 hover:bg-primary/20 rounded">
